...
<section class="farmlands-hero-section">
    ...
    <div class="farmlands-hero-content">
        <h3 class="farmlands-subtitle-top">HIGHWAY CITY</h3>
    ...
    <!-- Bottom info capsule (150+ Acres) -->
    <div class="farmlands-info-capsule">
        <div class="farmlands-acres">
            <span class="farmlands-acres-num">150+</span>
            <span class="farmlands-acres-label">ACRES</span>
        </div>
        <div class="farmlands-info-divider" aria-hidden="true"></div>
        <div class="farmlands-info-lines">
            <p>DESIGNED FOR GROWTH.</p>
            <p>BUILT FOR ENTERPRISE.</p>
            <p>CREATED FOR GENERATIONS.</p>
        </div>
    </div>
</section>
